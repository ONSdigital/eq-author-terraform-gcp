    ...
    applications = {
        ...
        "author" = {
            ...
            "envs" = {
                ...
                REACT_APP_LAUNCH_URL="https://${var.domain_prefix}.author.eqbs.gcp.onsdigital.uk/launch"
        ...
        "extract-questions" = {
            ...
            cpu = "1"
            envs = {
                AUTHOR_SCHEMA_URL="https://${var.domain_prefix}.author.eqbs.gcp.onsdigital.uk/export/"
                RUNNER_SCHEMA_URL="https://${var.domain_prefix}.publisher.eqbs.gcp.onsdigital.uk/publish/"
            }
            "secrets" = {}
        },
